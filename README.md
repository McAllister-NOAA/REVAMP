...
[![DOI](https://zenodo.org/badge/653783784.svg)](https://doi.org/10.5281/zenodo.8195014)
...
Usage: revamp.sh
       ...
       -g Skip time-consuming figure generation step (optional)
...
* `-t`: Number of threads to use for multi-thread processes (Cutadapt and BLAST).
...
* `-g`: **OPTIONAL** Skips maps, phyloseq, and environmental fitting R scripts.
...
blastQueryCovCutoff=90 #percent of ASV length under which BLAST hits are not considered
